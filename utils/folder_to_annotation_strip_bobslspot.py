...
video_directory = "/mnt/4tb/data/bobslspot_mask"
...
for video_file in train_videos:
    ...
    word = video_id.split('_')[-2]             # Extract the word, e.g., 'nadir'
    word = word.replace("-", " ")
    annotation[video_id] = {
        "folder": "/mnt/4tb/data/bobslspot_mask",
        "mplug": word,
        "polish_mplug": "",
        "ofa": "",
        "sound_mplug": "",
...
output_file = "data/bobsl_spot/annotation.json"
...
notes_file = "data/bobsl_spot/notes.txt"
