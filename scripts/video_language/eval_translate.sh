CACHE_DIR="cache_dir"
ANNOTATION="data/phoenix/phoenix_test.json"
...
TORCH_DISTRIBUTED_DEBUG=DETAIL HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 torchrun --nnodes=1 --node_rank=0 --nproc_per_node 1 \
    ...
    --resume "/mnt/fast/nobackup/users/ef0036/LanguageBind/logs/mdgs_semantic_pretrain_phoenix_translate/checkpoints/checkpoint_epoch_24.pt" \
    --do_train
    # --do_eval \
