...
TORCH_DISTRIBUTED_DEBUG=DETAIL HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 torchrun --nnodes=1 --node_rank=0 --nproc_per_node 1 \
    ...
    --epochs 25 --batch-size 1 --accum-freq 1 --warmup 2000 \
    ...
    --resume "/mnt/fast/nobackup/users/ef0036/LanguageBind/logs/bs128_a100_text_freeze_semantic_pop_bobsl_capt_8/checkpoints/epoch_18.pt" \
    --do_train
    # --do_eval \
